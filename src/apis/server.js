/**
 * FrontQL Local Development Server
 * 
 * Proxies requests to FrontQL cloud with authentication.
 * Run with: bun src/apis/server.js
 * 
 * NOTE: basicAuth token regenerates every 24 hours from FrontQL dashboard.
 */
...
const basicAuth = "Basic czVfaW50ZXJuX2RhdGFiYXNlLDE3Njg4MDA1MzMwNzQ6TVROdWRIWnQ=";  // regenerates after 24hrs
...
console.log("FrontQL dev server running: http://localhost:4466");
